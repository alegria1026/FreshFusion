      ...
      <div className={styles.container}>
        ...
        <div className={styles.column}>
          ...
          <address className={styles.address}>
            <p>Av. Francisco I Madero #308</p>
            <p>Col. Guadalupe Victoria</p>
            <p>C.P. 96510</p>
            <p>Coatzacoalcos, Veracruz</p>
          </address>
          
          <div className={styles.contact}>
            <p>Tel. <a href="tel:9213892763" className={styles.link}>9213892763</a></p>
        ...
        <div className={styles.columnM}>
          <h3 className={styles.columnMenu}>MENÚ</h3>
        ...
        <div className={styles.column}>
          ...
          <div className={styles.socialIcons}>
            <a href="https://wa.me/c/5219213892763" className={styles.socialLink} aria-label="WhatsApp">
            ...
            <a href="https://www.instagram.com/freshfusion" className={styles.socialLink} aria-label="Instagram">
